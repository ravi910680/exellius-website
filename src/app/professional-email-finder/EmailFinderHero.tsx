    ...
    <section className="relative w-full py-24 pt-60 bg-[#fcf4fc] overflow-hidden text-center">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-12">
          ...
          Find the Verified <span className="text-[#9856F2]"> Email Address </span>of Any <br /> Professional by Name
  ...
  <div className="flex justify-center">
    <div className="flex w-full max-w-4xl bg-white rounded-lg shadow-sm overflow-hidden border border-[#e0d0f5] items-stretch flex-nowrap">
      <input
        ...
        className="w-[35%] min-w-[150px] py-4 px-4 text-sm outline-none text-black bg-transparent border-r border-[#e0d0f5]"
      />
      ...
      <input
        ...
        className="w-[35%] min-w-[150px] py-4 px-4 text-sm outline-none text-black bg-transparent border-r border-[#e0d0f5]"
      />
      <button className="w-[30%] bg-[#9856F2] hover:bg-[#7e48d6] text-white font-semibold text-sm px-6 whitespace-nowrap">
        Find email address
      </button>
    </div>
  </div>
